...
class CustomerUser extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'google_id', 'facebook_id', 'linkedin_id', 'avatar',
    ...
    {
        return !$this->hasPassword() && ($this->hasSocialAccount('google') || $this->hasSocialAccount('facebook') || $this->hasSocialAccount('linkedin'));
    }
