...
use App\Http\Requests\Customer\IndividualRegisterRequest;
...
class AuthController extends Controller
{
    ...
    public function showRegistrationForm(Request $request)
    {
        ...
        return view('customer.auth.register', ['type' => $type]);
    }

    public function showRegistrationTypeSelection()
    {
        return view('customer.auth.register-type');
    }

    public function showSimpleRegistrationForm()
    {
        return view('customer.auth.register', ['type' => 'company']);
    }
    ...
    public function registerIndividual(IndividualRegisterRequest $request)
    {
        try {
            DB::beginTransaction();
            ...
            $customer = Customer::create([
                ...
                'email' => $request->email,
                'status' => 'pending',
                'credit_limit' => 500.00, // Lower limit for individuals
                'current_balance' => 0.00,
            ...
            // Log the actual error for debugging
            \Log::error('Individual customer registration failed: '.$e->getMessage(), [
                'exception' => $e,
                'request_data' => $request->except(['password', 'password_confirmation']),
            ]);
