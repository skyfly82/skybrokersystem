...
Route::prefix('customer')->name('customer.')->group(function () {
    ...
    Route::middleware('guest:customer_user')->group(function () {
        ...
        Route::get('/register', [CustomerAuthController::class, 'showSimpleRegistrationForm'])->name('register');
        Route::post('/register/company', [CustomerAuthController::class, 'register'])->name('register.company');
        Route::post('/register/individual', [CustomerAuthController::class, 'registerIndividual'])->name('register.individual');

        // Social authentication routes
        Route::get('/auth/{provider}', [CustomerSocialAuthController::class, 'redirect'])->name('auth.social');
        Route::get('/auth/{provider}/callback', [CustomerSocialAuthController::class, 'callback'])->name('auth.social.callback');
