...
@section('content')
<form method="POST" action="{{ route('admin.login') }}" class="space-y-6" x-data="adminLogin">
    @csrf
                    ...
                    <ul class="mt-1 space-y-1">
                        <li>
                            <button 
                                ...
                                @click="fillCredentials('admin@skybroker.pl', 'password')"
                            >
                                admin@skybroker.pl / password
                            </button>
                        </li>
                        <li>
                            <button 
                                type="button"
                                class="font-mono text-xs hover:underline"
                                @click="fillCredentials('superadmin@skybroker.pl', 'password')"
                            >
                                superadmin@skybroker.pl / password
                            </button>
                        </li>
                    </ul>
                </div>
