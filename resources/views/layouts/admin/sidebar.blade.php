<div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4 border-r border-gray-200">
    <div class="flex h-16 shrink-0 items-center">
        <img class="h-8 w-auto" src="/images/logo.svg" alt="SkyBrokerSystem">
        <span class="ml-3 text-xl font-bold text-gray-900">SkyBroker</span>
    </div>
        ...
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
                ...
                <ul role="list" class="-mx-2 space-y-1">
                    ...
                    <li>
                        <a href="{{ route('admin.customers.index') }}" 
                           class="sidebar-nav-item {{ request()->routeIs('admin.customers.*') ? 'active' : '' }}">
                            ...
                            Customers
                            @if($pendingCustomers = \App\Models\Customer::where('status', 'pending')->count())
                                <span class="ml-auto inline-block py-0.5 px-2 text-xs rounded-full bg-warning-100 text-warning-800">
                                    {{ $pendingCustomers }}
                                </span>
                            @endif
                        </a>
                    ...
                    <li>
                        <a href="{{ route('admin.couriers.index') }}" 
                           class="sidebar-nav-item {{ request()->routeIs('admin.couriers.*') ? 'active' : '' }}">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0V8.25a1.5 1.5 0 013 0v10.5zM12 12.75a1.5 1.5 0 01-3 0V8.25a1.5 1.5 0 013 0v4.5zm3.75 6a1.5 1.5 0 01-3 0V8.25a1.5 1.5 0 013 0v10.5z" />
                            </svg>
                            Couriers
                ...
                <ul role="list" class="-mx-2 mt-2 space-y-1">
                    <li>
                        <a href="{{ route('admin.reports.shipments') }}" 
                           class="sidebar-nav-item {{ request()->routeIs('admin.reports.shipments') ? 'active' : '' }}">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="{{ route('admin.reports.revenue') }}" 
                           class="sidebar-nav-item {{ request()->routeIs('admin.reports.revenue') ? 'active' : '' }}">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <li class="mt-auto">
                <a href="{{ route('admin.logout') }}" 
                   class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-red-600 hover:bg-red-50 hover:text-red-700">
                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
