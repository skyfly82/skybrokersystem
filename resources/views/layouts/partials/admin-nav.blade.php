<ul role="list" class="flex flex-1 flex-col gap-y-7">
    ...
    <li>
        ...
        <ul role="list" class="-mx-2 mt-2 space-y-1">
            ...
            <!-- Customer Service -->
            <li>
                <a href="{{ route('admin.customer-service.dashboard') }}" class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold {{ request()->routeIs('admin.customer-service.*') ? 'bg-admin-50 text-admin-600' : 'text-gray-700 hover:text-admin-600 hover:bg-gray-50' }}">
                    <svg class="h-6 w-6 shrink-0 {{ request()->routeIs('admin.customer-service.*') ? 'text-admin-600' : 'text-gray-400 group-hover:text-admin-600' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
