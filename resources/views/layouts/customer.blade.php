            ...
            <div class="relative flex w-full max-w-xs flex-1 flex-col bg-white">
                ...
                <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
                    ...
                    <nav class="mt-8 flex-1 space-y-1 px-2">
                        ...
                        <a href="{{ route('customer.orders.index') }}" class="group flex items-center rounded-md px-2 py-2 text-sm font-medium {{ request()->routeIs('customer.orders.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-700 hover:bg-gray-50 hover:text-gray-900' }}">
                            <svg class="mr-3 h-6 w-6 {{ request()->routeIs('customer.orders.*') ? 'text-blue-500' : 'text-gray-400 group-hover:text-gray-500' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <div x-data="{ open: {{ request()->routeIs('customer.profile.*') || request()->routeIs('customer.users.*') || request()->routeIs('customer.finances.*') || request()->routeIs('customer.logs.*') ? 'true' : 'false' }} }">
                            ...
                            <div x-show="open" x-transition class="relative z-[100] space-y-1 pl-11">
                                ...
                                <a href="{{ route('customer.finances.index') }}" class="group flex items-center rounded-md px-2 py-2 text-sm font-medium {{ request()->routeIs('customer.finances.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                    Finanse
                                </a>
                                
                                <a href="{{ route('customer.logs.index') }}" class="group flex items-center rounded-md px-2 py-2 text-sm font-medium {{ request()->routeIs('customer.logs.*') ? 'bg-blue-100 text-blue-900' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                                    Log systemowy
                                </a>
