                    ...
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            ...
                            <template x-if="toast.type === 'info'">
                                <svg class="h-6 w-6 text-skywave" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <div class="ml-4 flex flex-shrink-0">
                            <button type="button" @click="remove(toast.id)" class="inline-flex rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-skywave focus:ring-offset-2">
