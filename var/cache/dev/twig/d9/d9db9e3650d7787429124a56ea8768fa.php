...
/* login_admin.html.twig */
class __TwigTemplate_3b6f235612977516f53a7ed365e51f10 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "login_admin.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "login_admin.html.twig"));
...
<head>
    ...
    <title>Logowanie administratora — SkyBroker</title>
    ...
    <style>
        :root { --primary:#2F7DFF; --primary-600:#2568d6; --primary-50:#EEF5FF; --text:#0C0212; --muted:#64748b; --border:#e5e7eb; --bg:#FFFFFF; }
...
<body>
    <div class=\"container\">
        ...
        <h1 style=\"margin-bottom:8px; font-size:1.4em\">Logowanie administratora</h1>
        ...
        <form id=\"loginForm\">
            ...
            <div class=\"links\">
                <a class=\"alink\" href=\"/v2/login/customer\">Logowanie klienta</a>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', async (e)=>{
            ...
            try{
                const endpoint = `\${API_BASE}/system/login`;
                ...
                if(r.ok && data.success){
                    ...
                    localStorage.setItem('user_type', 'system');
                    localStorage.setItem('user_data', JSON.stringify(data.user));
                    location.href = '/v2/dashboard?type=system';
                } else {
...
", "login_admin.html.twig", "/var/www/skybrokersystem_v2/templates/login_admin.html.twig");
    }
}
