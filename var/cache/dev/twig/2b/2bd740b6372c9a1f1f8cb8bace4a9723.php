...
/* dashboard.html.twig */
class __TwigTemplate_f7445a8372bdf8fd313fe6f31b460c5c extends Template
{
...
<body>
        ...
        <div class=\"tab-content\" id=\"email-testTab\">
            <div class=\"card\">
                ...
                <div class=\"api-test\">
                    ...
                    <a href=\"/mailhog/\" target=\"_blank\" class=\"btn btn-info\">Otwórz MailHog UI</a>
    ...
    <script>
        ...
        async function sendTestEmail() {
            ...
            try {
                const response = await fetch('/v2/test-email', {
                    method: 'GET'
                });
        ...
        async function sendCustomEmail() {
            ...
            try {
                const response = await fetch('/v2/send-email', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
...
</html>", "dashboard.html.twig", "/var/www/skybrokersystem_v2/templates/dashboard.html.twig");
    }
}
