...
/* login.html.twig */
class __TwigTemplate_5185afef9574a68ebdb303bfc93d232f extends Template
{
...
<head>
    ...
    <title>Logowanie — SkyBroker</title>
        ...
        document.getElementById('loginForm').addEventListener('submit', async (e)=>{
            ...
            try{
                ...
                if(r.ok && data.success){
                    ...
                    location.href = '/v2/dashboard?type='+utype;
                } else {
...
", "login.html.twig", "/var/www/skybrokersystem_v2/templates/login.html.twig");
    }
}
