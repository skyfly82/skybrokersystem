 ...
 */
class getDebug_Security_Authenticator_JsonLogin_CustomerApiService extends App_KernelProductionDebugContainer
{
    /**
     * Gets the private 'debug.security.authenticator.json_login.customer_api' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['debug.security.authenticator.json_login.customer_api'])) {
            return $container->privates['debug.security.authenticator.json_login.customer_api'];
        }
