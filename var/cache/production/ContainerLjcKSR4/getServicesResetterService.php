...
class getServicesResetterService extends App_KernelProductionDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () use ($container) {
            ...
            if (isset($container->privates['debug.security.firewall.authenticator.customer_api'])) {
                yield 'debug.security.firewall.authenticator.customer_api' => ($container->privates['debug.security.firewall.authenticator.customer_api'] ?? null);
            }
            if (isset($container->privates['debug.security.firewall.authenticator.system_api'])) {
                yield 'debug.security.firewall.authenticator.system_api' => ($container->privates['debug.security.firewall.authenticator.system_api'] ?? null);
            }
            ...
            if (isset($container->privates['debug.security.event_dispatcher.customer_api'])) {
                yield 'debug.security.event_dispatcher.customer_api' => ($container->privates['debug.security.event_dispatcher.customer_api'] ?? null);
            }
            if (isset($container->privates['debug.security.event_dispatcher.system_api'])) {
                yield 'debug.security.event_dispatcher.system_api' => ($container->privates['debug.security.event_dispatcher.system_api'] ?? null);
            }
